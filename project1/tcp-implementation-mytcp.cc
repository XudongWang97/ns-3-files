...
NS_LOG_COMPONENT_DEFINE ("TcpImplementationMYTCP");  
...
main (int argc, char *argv[])  
{
  ...
  // MYTCP
  Config::SetDefault ("ns3::TcpHybla::useMYTCP", BooleanValue (true));
  ...
  if (flow_monitor)
    {
      flowHelper.SerializeToXmlFile ("tcp-implementation-mytcp.flowmonitor", true, true);
    }
