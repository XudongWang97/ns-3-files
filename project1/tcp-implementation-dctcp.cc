...
NS_LOG_COMPONENT_DEFINE ("TcpImplementationDCTCP");  
...
main (int argc, char *argv[])  
{
  ...
  Config::SetDefault ("ns3::RedQueueDisc::UseDCTCP", BooleanValue (true));
  Config::SetDefault ("ns3::RedQueueDisc::MinTh", DoubleValue (5));
  Config::SetDefault ("ns3::RedQueueDisc::MaxTh", DoubleValue (5));
  ...
  if (flow_monitor)
    {
      flowHelper.SerializeToXmlFile ("tcp-implementation-dctcp.flowmonitor", true, true);
    }
