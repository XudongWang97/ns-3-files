...
public:
  ...
  // DCTCP
  double                 m_alpha;           //!< Fraction of marked packets
  double                 m_g;               //!< change rate of alpha
  uint32_t               m_markedAckCount;     //!< number of marked packets
  uint32_t               m_ackCount;   //!< number of unmarked packets
...
protected:
  // DCTCP
  bool                   m_useDCTCP;          //!< DCTCP enabled
  bool                   m_CEstate;           //!< the CE state for the state machine in Figure 10
